...
class Level4Tests(unittest.TestCase):
    ...
    def test_level_4_case_02_shows_correct_spender_stats(self):
        ...
        expected = ['account1(600)', 'account4(500)', 'account2(400)'] # account 3 should have deposited 400 into account 2.
    ...
    def test_level_4_case_09_all_operations_2(self):
        ...
        self.assertEqual(self.system.get_balance(25, 'account1', 25), 3400) # Joyce
        self.assertEqual(self.system.get_balance(26, 'account2', 15), 1700) # Brandon 
